...
interface Content @requiresProject(fields: ["type"]) {
  ...
  userRegistration: ContentUserRegistration! @projection(
    localField: "mutations.Website.requiresAccessLevels",
    needs: [
      "mutations.Website.requiresRegistration",
      "mutations.Website.requiresRegistrationOptions",
      "mutations.Website.bypassGating",
    ]
  )
