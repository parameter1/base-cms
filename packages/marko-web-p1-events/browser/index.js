...
const TrackContentBodyViewDepth = () => import(/* webpackChunkName: "p1-events-track-content-body-view-depth" */ './track-content-body-view-depth.vue');
...
export default (Browser) => {
  ...
  Browser.register('P1EventsTrackContentBodyViewDepth', TrackContentBodyViewDepth);
